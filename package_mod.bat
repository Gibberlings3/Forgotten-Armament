...
set "mod_name=Forgotten Armament"
set "mod_version=v0.7.3-beta"
set mod_folder=forgotten-armament
...
set mod_readme=https://github.com/Gibberlings3/Forgotten-Armament/blob/main/README.md
